...
function showCharacterSelection(playerNum) {
  ...
  characters.forEach(char => {
    ...
    card.innerHTML = `<img src="characters/${char}" alt="${char}">`;
...
function startGame() {
  ...
  // Set player avatars
  document.querySelector('.player1-info .player-avatar').src = `characters/${gameState.player1Character}`;
  document.querySelector('.player2-info .player-avatar').src = `characters/${gameState.player2Character}`;
...
function makeMove(index, player) {
  ...
  img.src = `characters/${player === 1 ? gameState.player1Character : gameState.player2Character}`;
...
function updateTurnIndicator() {
  ...
  turnIndicator.innerHTML = `<img src="characters/${gameState.currentPlayer === 1 ? gameState.player1Character : gameState.player2Character}" alt="Current turn">`;
}
...
function showResultScreen() {
  ...
  if (gameState.winner === null) {
    ...
    winnerAvatar.src = `characters/${gameState.winner === 1 ? gameState.player1Character : gameState.player2Character}`;
